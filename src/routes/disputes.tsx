...
export const Route = createFileRoute("/disputes")({
  ...
  pendingMs: 0,
  pendingMinMs: 400,
  pendingComponent: () => (<SplitSkeleton {...{ eyebrow: "Resolution" }} />),
...
type Dispute = {
  ...
  status: "Open" | "Investigating" | "Awaiting" | "Resolved";
  location: string;
  evidence: number;
  thread: { who: string; side: "left" | "right"; msg: string; t: string }[];
};

const disputes: Dispute[] = [
  {
    id: "D-1187", title: "Service not completed", parties: "Alex G. ↔ Marcus T.",
    amount: 220, sla: "2h 12m", priority: "High", status: "Open",
    location: "Brooklyn, NY", evidence: 3,
    thread: [
  ...
  {
    id: "D-1186", title: "Damaged item during move", parties: "Iris Co. ↔ Stratus",
    amount: 480, sla: "5h 04m", priority: "High", status: "Investigating",
    location: "Queens, NY", evidence: 5,
    thread: [
      { who: "Iris Co.", side: "left",  msg: "A vintage lamp arrived shattered.", t: "6h ago" },
      { who: "Stratus",  side: "right", msg: "We packed per protocol. Reviewing footage.", t: "4h ago" },
      { who: "Admin",    side: "right", msg: "Photos requested from both parties.", t: "1h ago" },
    ],
  },
  {
    id: "D-1185", title: "Incorrect billing", parties: "Noah B. ↔ Helena N.",
    amount: 89, sla: "12h", priority: "Medium", status: "Awaiting",
    location: "Manhattan, NY", evidence: 2,
    thread: [
      { who: "Noah B.",  side: "left",  msg: "Charged twice for the same booking.", t: "1d ago" },
      { who: "Helena N.", side: "right", msg: "Looking into the duplicate charge now.", t: "20h ago" },
    ],
  },
  {
    id: "D-1184", title: "Refund requested", parties: "Sofia L. ↔ Northwind",
    amount: 156, sla: "1d", priority: "Low", status: "Open",
    location: "Jersey City, NJ", evidence: 1,
    thread: [
      { who: "Sofia L.",   side: "left",  msg: "Service didn't match the listing description.", t: "1d ago" },
      { who: "Northwind",  side: "right", msg: "Happy to issue a partial refund.", t: "18h ago" },
    ],
  },
  {
    id: "D-1183", title: "Worker no-show", parties: "Liam O. ↔ Carlos R.",
    amount: 110, sla: "—", priority: "High", status: "Resolved",
    location: "Bronx, NY", evidence: 0,
    thread: [
      { who: "Liam O.",   side: "left",  msg: "Worker never showed up for the appointment.", t: "3d ago" },
      { who: "Carlos R.", side: "right", msg: "Apologies — emergency. Refund issued.", t: "2d ago" },
      { who: "Admin",     side: "right", msg: "Case closed. Full refund processed.", t: "2d ago" },
    ],
  },
];
      ...
      <div className="grid grid-cols-12 gap-4">
                ...
                return (
                  <tr
                    ...
                    className={`border-t border-white/5 cursor-pointer transition ${
                      isActive
                        ? "bg-[oklch(0.62_0.21_275_/_0.10)] hover:bg-[oklch(0.62_0.21_275_/_0.14)]"
        ...
        <div className="col-span-12 xl:col-span-4 rounded-2xl glass gradient-border p-5">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="text-sm font-semibold text-white">Case #{selected.id}</h3>
          </div>
          <div className="text-xs text-white/55">{selected.title} · ${selected.amount} · {selected.location}</div>
          ...
          <div className="mt-3 text-[11px] text-white/40 inline-flex items-center gap-1"><FileText className="h-3 w-3" />{selected.evidence} evidence files attached</div>
        </div>
      </div>
    </PageShell>
  );
